...
- [4-3-manimcat-review-compat-fix-20260415.md](./implementation-artifacts/4-3-manimcat-review-compat-fix-20260415.md) - Story 4.3 基于 `references/ManimCat-main` 的审查与兼容修复记录，收口测试导入断裂、preview 完成态覆盖和旧 façade 缺失问题
