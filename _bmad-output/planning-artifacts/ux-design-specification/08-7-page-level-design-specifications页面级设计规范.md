...
| 首页与入口 | `/` | 默认产品首页中的课堂直达入口与顶栏导航分发 | FastAPI + RuoYi | P0 |
...
* 模块：品牌价值、课堂主入口与其他学习能力总览、智能师生匹配亮点、试点方案、FAQ、联系 CTA。
* 关键约束：
...
* 目标：作为默认产品首页，让用户在 3 秒内通过单一主 CTA 进入课堂工作区，并通过顶栏导航进入其他有效入口。
* 模块：Logo、顶栏导航、单一主 CTA、最近学习入口、登录入口。
* 主入口文案：`进入课堂工作区`
* 导航语义：顶栏承接其他学习入口与账号动作，不再要求用户在首页做双入口比较。
