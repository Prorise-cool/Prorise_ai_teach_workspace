...
> **变更说明（2026-03-27）**
> Story 3.1 当前只负责统一事件契约、状态恢复语义和接口验证。
> 正式等待页组件与视觉交互迁移到 Epic 9。
...
> **变更说明（2026-03-27）**
> 当前执行窗口聚焦任务创建、课堂内容生成、结果 schema 与恢复语义。
> 正式课堂输入页、等待页和结果页交付迁移到 Epic 9。
...
> **变更说明（2026-03-27）**
> 当前执行窗口优先交付测验 / 历史相关数据与接口闭环。
> 正式测验页、历史记录页与结果重开页面交付迁移到 Epic 10。
