...
FR-VS-010: Epic 3 - 视频输入页中的公开视频发现与复用入口  
FR-VP-001: Epic 4 - 视频播放  
FR-VP-002: Epic 4 - 倍速播放  
FR-VP-003: Epic 4 - 进度控制与全屏  
FR-VP-004: Epic 4 - 视频结果公开发布与输入页复用  
FR-CS-001: Epic 5 - 主题输入与基础课堂生成  
FR-CS-002: Epic 1 - 用户配置系统（个人简介与学习偏好）作为启动配置的一部分  
...
FR-CS-008: Epic 5 - 课堂输入页联网搜索增强与范围配置  
FR-CS-009: Epic 5 - 课堂结果导出与分享产物  
