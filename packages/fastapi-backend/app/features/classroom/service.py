...
class ClassroomService:
    ...
    def persist_task(self, request: ClassroomTaskMetadataCreateRequest) -> ClassroomTaskMetadataPreviewResponse:
        snapshot = self._repository.save_task(request, default_task_type=TaskType.CLASSROOM)
    ...
    def get_task(self, task_id: str) -> ClassroomTaskMetadataSnapshot | None:
    ...
    def replay_session(self, session_id: str) -> ClassroomTaskMetadataPageResponse:
