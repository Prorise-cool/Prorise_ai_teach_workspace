...
## 核心原则：讲透 > 一切
- 每个知识点必须讲透。宁可多设计几个section，也不要蜻蜓点水。
- 如果一个概念需要5个section才能让学生理解，就设计5个section。
- 短视频敷衍式讲解是最大质量问题，必须避免。
...
- The input may specify a target duration and number of sections.
