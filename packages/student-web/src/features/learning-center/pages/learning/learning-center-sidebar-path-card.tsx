  ...
  if (!path) {
    return (
      <Link
        ...
        className="view-enter stagger-1 bg-surface-light dark:bg-surface-dark text-text-primary dark:text-text-primary-dark border border-bordercolor-light dark:border-bordercolor-dark rounded-2xl p-6 md:p-8 relative overflow-hidden block shadow-md hover:shadow-lg btn-transition"
      >
        <div className="absolute -right-6 -top-6 opacity-[0.08]">
          <Compass className="w-32 h-32 text-text-primary dark:text-brand" />
        </div>
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xs font-bold uppercase tracking-widest text-text-secondary dark:text-text-secondary-dark">
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="flex justify-between text-xs font-bold mb-3 text-text-secondary dark:text-text-secondary-dark">
          <span>{t('learningCenter.page.pathProgressLabel')}</span>
          <span>{progressPercent}% ({progressRatio})</span>
        </div>
        <div className="w-full h-1.5 bg-accent dark:bg-bg-dark rounded-full overflow-hidden">
          <div
