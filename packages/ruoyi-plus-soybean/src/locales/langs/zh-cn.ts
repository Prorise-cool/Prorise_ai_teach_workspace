  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: '项目动态',
        moreNews: '更多动态',
        desc1: '小麦团队在2021年5月28日创建了开源项目 Xiao-Mai!',
        desc2: 'Yanbowe 向 Xiao-Mai 提交了一个bug，多标签栏不会自适应。',
        desc3: '小麦团队准备为 Xiao-Mai 的发布做充分的准备工作!',
        desc4: '小麦团队正在忙于为 Xiao-Mai 写项目说明文档！',
        desc5: '小麦团队刚才把工作台页面随便写了一些，凑合能看了！'
      },
      creativity: '创意'
    },
    common: {
    ...
    about: {
      title: '关于',
      introduction: `Xiao-Mai 是一个现代化的企业级多租户管理系统，它结合了 RuoYi-Vue-Plus 的强大后端功能和现代化前端特性，为开发者提供了完整的企业管理解决方案。`,
      projectInfo: {
        title: '项目信息',
        version: '版本',
