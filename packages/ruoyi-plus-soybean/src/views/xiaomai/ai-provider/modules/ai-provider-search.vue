        ...
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="80">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:6" label="供应商" label-width="auto" path="vendorCode" class="pr-24px">
              <DictSelect v-model:value="model.vendorCode" placeholder="全部" dict-code="xm_ai_vendor_code" clearable />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:6" label="名称" label-width="auto" path="providerName" class="pr-24px">
              <NInput v-model:value="model.providerName" placeholder="按名称搜索" clearable />
            </NFormItemGi>
